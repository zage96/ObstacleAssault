This little project consists on a character that needs to get into  a final platform. There are obstacles that move from one side to another, up and down and rotate on their own axis.
